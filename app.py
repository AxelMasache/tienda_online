...
def nuevo_producto_fisico():
    if request.method == "POST":
        try:
            ...
            # 2. Crear el producto pasando el nombre de la imagen
            producto = ProductoFisico(
                ...
                imagen=nombre_imagen  # <-- El campo nuevo
            )
