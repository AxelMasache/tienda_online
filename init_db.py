...
with app.app_context():
    ...
    p1 = ProductoFisico(
        ...
        stock=40, peso_kg=0.3, costo_envio_por_kg=2.50,imagen="audifonos_inalambricos.jpg"
    )
    p2 = ProductoDigital(
        codigo="DIG001", nombre="Curso de Python Avanzado", precio_base=40.00,
        stock=999, licencia="personal",imagen="python.jpg"
    )
    p3 = ProductoPerecible(
        codigo="PER001", nombre="Caja de fresas orgánicas", precio_base=8.00,
        stock=15, dias_para_vencer=2,imagen="fresas_organicas.jpg"
    )
